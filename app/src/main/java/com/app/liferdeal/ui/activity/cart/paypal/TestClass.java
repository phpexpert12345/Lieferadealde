...
public class TestClass extends Activity {
    ...
    private static final String CONFIG_CLIENT_ID = "AQHfmd4zcwJ_-pp79mZAmdWYDE8QMNkPd6jv5jh6lMFsDySokm0SOcV9WeUqQPGL06avk5U2gWRVsjEG";
    ...
    public void onBuyPressed(View pressed) {
        ...
        Intent intent = new Intent(TestClass.this, PaymentActivity.class);
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(TestClass.this, PayPalFuturePaymentActivity.class);
    ...
    public void onProfileSharingPressed(View pressed) {
        Intent intent = new Intent(TestClass.this, PayPalProfileSharingActivity.class);
