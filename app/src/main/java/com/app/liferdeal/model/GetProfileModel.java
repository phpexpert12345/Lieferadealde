...
public class GetProfileModel {
    ...
    public class User {
        ...
        public List<GetProfileDeliveryaddressModel> getDeliveryaddress() {
            return deliveryaddress;
        }

        public void setDeliveryaddress(List<GetProfileDeliveryaddressModel> deliveryaddress) {
            this.deliveryaddress = deliveryaddress;
        }

        @SerializedName("deliveryaddress")
        @Expose
        private List<GetProfileDeliveryaddressModel> deliveryaddress = null;
